...
// Full-site submissions are intentionally disabled. IndexNow must be event-driven from
// publication/visibility mutations, never coupled to a public sitemap GET.
export async function submitAllPublished(){
  return {ok:true,status:null,submitted:0,skipped:true,reason:'bulk_submission_disabled_use_event_driven'};
}
