...
export function validateSocialCopy({network,value,locale,article_url}){
 ...
 const errors=[...base.errors],warnings=[...base.warnings],found=urls(v);
 ...
 return{network,ready:errors.length===0,chars:base.chars,hashtags:base.hashtags,errors:[...new Set(errors)],warnings:[...new Set(warnings)]};
}
